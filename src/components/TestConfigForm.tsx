    ...
    <div className={room.status === 'configured' ? "card-highlight" : "card"}>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label htmlFor="timeout_ms" className="block text-sm font-medium mb-2">
              Timeout (ms)
            </label>
            <div className="relative">
              <input
          ...
          <div>
            <label htmlFor="requests_per_client" className="block text-sm font-medium mb-2">
              Requests Per Client
            </label>
            <div className="relative">
              <input
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-xs text-gray-500">{Object.keys(config.headers).length} headers</span>
          </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {Object.entries(config.headers).map(([key, value]) => (
                    <tr key={key} className="border-t border-gray-100 dark:border-gray-600">
                      <td className="px-4 py-2 font-medium">{key}</td>
                      <td className="px-4 py-2 text-gray-600 dark:text-gray-300">{value}</td>
                      {isConfigurable && (
