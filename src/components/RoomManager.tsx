    ...
    return (
      <div className="card-highlight">
        <div className="flex items-center mb-4">
          ...
          <span className={`ml-auto badge ${room.status === 'waiting' ? 'badge-info' : room.status === 'configured' ? 'badge-warning' : room.status === 'running' ? 'badge-success' : 'badge-info'}`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="font-medium flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-armandra" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                </svg>
                {room.clientCount}
              </p>
  ...
  return (
    <div className="card">
      ...
      <div className="relative flex items-center justify-center mb-6">
        ...
        <span className="bg-white dark:bg-gray-800 px-3 text-sm text-gray-500 dark:text-gray-400 relative">or</span>
      </div>
