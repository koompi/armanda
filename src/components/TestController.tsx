      ...
      <div className="card-highlight">
        ...
        <div className="bg-white dark:bg-gray-700 rounded-xl p-4 mb-4 border border-gray-100 dark:border-gray-600">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <p className="text-xs text-gray-500 dark:text-gray-400">Timeout</p>
              <p className="font-medium">{testConfig?.timeout_ms} ms</p>
            </div>
            <div className="space-y-1">
              <p className="text-xs text-gray-500 dark:text-gray-400">Requests Per Client</p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium">{testConfig?.requests_per_client} per client</p>
              </div>
            </div>
          </div>
        </div>
